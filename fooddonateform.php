...
if(isset($_POST['submit']))
{
    ...
    if($query_run)
    {
        ...
        // Trigger a notification to the admin
        $notif_msg = "New donation: " . $foodname . " from " . $name . " in " . $district;
        $notif_query = "INSERT INTO notifications (message, status) VALUES ('$notif_msg', 'unread')";
